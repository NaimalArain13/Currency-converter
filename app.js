...
//06
let conversionRate = `https://v6.exchangerate-api.com/v6/9b2f0b58760d97970ab45a1e/pair/${firstCountry.name}/${secondCountry.name}`;
//07
...
let result = `Your ${chalk.cyanBright.bold(firstCountry.name)} ${chalk.cyanBright.bold(userMoney.money)} in ${chalk.cyanBright.bold(secondCountry.name)} is ${chalk.cyanBright.bold(convertedRate)}`;
console.log(result);
